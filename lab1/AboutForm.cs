...
namespace lab1
{
    public partial class AboutForm : Form
    {
        ...
        private void AboutForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawCurve(myPen, new Point[] { new Point(110, 145), new Point(110, 165), new Point(120, 165), new Point(120, 145), new Point(120, 165), new Point(130, 165), new Point(130, 145), new Point(130, 165), new Point(135, 165), new Point(137, 175), new Point(133, 175), new Point(135, 165), new Point(140, 165) });
            g.DrawCurve(myPen, new Point[] { new Point(160, 145), new Point(145, 145), new Point(145, 165), new Point(155, 165), new Point(160, 145), new Point(160, 165), new Point (165, 165) });
